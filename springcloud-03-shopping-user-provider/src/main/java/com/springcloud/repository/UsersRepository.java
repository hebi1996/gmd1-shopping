...
public interface UsersRepository extends JpaRepository<Users,Integer>,JpaSpecificationExecutor<Users> {
	 ...
	 */
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,u.userNumber,u.userPassword,u.userSex,u.userPhone,u.userSite,u.userBirthday,u.userEmail,u.userPhoto,u.userStatus,u.jdictionId)from com.springcloud.entity.Users u where u.userId=:userId and u.userPassword=:userPassword and u.jdictionId=:jdictionId and u.userStatus=0")
	 ...
	 */
	@Modifying
	@Query("update Users u set u.userNumber=:#{#users.userNumber},u.userSex=:#{#users.userSex},u.userEmail=:#{#users.userEmail},u.userPhone=:#{#users.userPhone},u.userSite=:#{#users.userSite},u.userBirthday=:#{#users.userBirthday} where u.userId=:#{#users.userId}")
